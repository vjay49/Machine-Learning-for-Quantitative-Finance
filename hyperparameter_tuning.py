...
with pd.ExcelWriter(path + 'Lasso penalty grid 20240321_0914.xlsx') as writer:
...
with pd.ExcelWriter(path + 'Tree output many combinations 20240321_0924.xlsx') as writer:
