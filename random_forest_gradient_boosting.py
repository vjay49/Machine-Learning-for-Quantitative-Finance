...
# Export results to Excel
with pd.ExcelWriter(path + 'Gradient boost output 20240325_1852.xlsx') as writer:
...
# Export results to Excel
with pd.ExcelWriter(path + 'Gradient boost output with different parameters 20240315_1900.xlsx') as writer:
    results_full.to_excel(writer, sheet_name='results_full')
    results_train.to_excel(writer, sheet_name='results_train')
    results_test.to_excel(writer, sheet_name='results_test')
