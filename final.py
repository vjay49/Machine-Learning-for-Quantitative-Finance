...
# Import data
returns1 = pd.read_excel(path + 'Aggregate data 20240331_1312.xlsx', sheet_name='returns23')
...
correlation_matrix = returns1[['rettr', 'abrettr', 'indabrettr', 'lnmktcaptr', 'bidasktr', 'turntr', 'pegtr',
                 'putcalltr', 'bmatr', 'int_ebittr', 'empgtr', 'revgrtr', 'roetr',
                 'crtr', 'capex_salestr', 'patentstr', 'lnpatentstr', 'cfi_salestr', 'insidertr',
                 'payouttr', 'sentimenttr', 'detr']].corr()
...
# Export to Excel
with pd.ExcelWriter('Project 20240331_1439.xlsx') as writer:
...
x_train = returns_train[['lnmktcapadj', 'bidaskadj', 'turnadj', 'pegadj', 'putcalladj', 'bmaadj', 'int_ebitadj',
'empgadj', 'revgradj', 'roeadj', 'cradj', 'capex_salesadj', 'lnpatentsadj', 'cfi_salesadj', 'insideradj',
'payoutadj', 'sentimentadj', 'deadj',
'bidaskmiss', 'pegmiss', 'putcallmiss', 'bmamiss', 'int_ebitmiss', 'empgmiss', 'revgrmiss', 'roemiss', 'crmiss',
'capex_salesmiss', 'lnpatentsmiss', 'cfi_salesmiss', 'insidermiss', 'payoutmiss', 'sentimentmiss', 'demiss']]
...
x_test = returns_test[['lnmktcapadj', 'bidaskadj', 'turnadj', 'pegadj', 'putcalladj', 'bmaadj', 'int_ebitadj',
'empgadj', 'revgradj', 'roeadj', 'cradj', 'capex_salesadj', 'lnpatentsadj', 'cfi_salesadj', 'insideradj',
'payoutadj', 'sentimentadj', 'deadj',
'bidaskmiss', 'pegmiss', 'putcallmiss', 'bmamiss', 'int_ebitmiss', 'empgmiss', 'revgrmiss', 'roemiss', 'crmiss',
'capex_salesmiss', 'lnpatentsmiss', 'cfi_salesmiss', 'insidermiss', 'payoutmiss', 'sentimentmiss', 'demiss']]
...
with pd.ExcelWriter(path + 'Lasso penalty grid 20240331_1444.xlsx') as writer:
...
plt.savefig(path + 'Basic decision tree importance 20240331_1427.pdf')
plt.show()
...
plt.xticks(rotation=90)
plt.savefig(path + 'Basic decision tree importance train 20240331_1450.pdf')
plt.show()
...
with pd.ExcelWriter(path + 'Tree output many combinations 20240331_1451.xlsx') as writer:
...
# Export results to Excel
with pd.ExcelWriter(path + 'Decision-tree output 20240331_1451.xlsx') as writer:
...
# Export results to Excel
with pd.ExcelWriter(path + 'Random forest output 20240331_1504.xlsx') as writer:
...
# Export results to Excel
with pd.ExcelWriter(path + 'Random forest output with different parameters 20240331_1515.xlsx') as writer:
    results_full.to_excel(writer, sheet_name='results_full')
    results_train.to_excel(writer, sheet_name='results_train')
    results_test.to_excel(writer, sheet_name='results_test')
...
# Export results to Excel
with pd.ExcelWriter(path + 'Gradient boost output 20240331_1518.xlsx') as writer:
...
# Export results to Excel
with pd.ExcelWriter(path + 'Gradient boost output with different parameters 20240331_1520.xlsx') as writer:
    results_full.to_excel(writer, sheet_name='results_full')
    results_train.to_excel(writer, sheet_name='results_train')
    results_test.to_excel(writer, sheet_name='results_test')
